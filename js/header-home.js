...
if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {    
    ...
    function myFunction() {
        if (window.pageYOffset > sticky) {
            ...
            btn1.classList.remove("hamburger__top-bu");
            btn2.classList.remove("hamburger__bottom-bu");
            ...
            btn1.classList.add("hamburger__top-bu");
            btn2.classList.add("hamburger__bottom-bu");  
